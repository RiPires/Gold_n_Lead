...
###                 Plots                     ###
VdG_Plot('0922/ERDrun2.dat') # Au 1 w/ contaminations
VdG_Plot('0922/ERDrun4.dat') # Pb 1   
#VdG_Plot('0922/ERDrun9.dat') # Calib. not good   
VdG_Plot('0922/ERDrun7.dat') # C
VdG_Plot('0922/ERDrun15.dat') # CaF2 on Carbon 
#################################################